...
public class SignalStaticActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signal_static);

        context = this.getApplicationContext();

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle(context.getResources().getString(R.string.title_activity_signal_static));
        ...
        gps_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent it = new Intent(SignalStaticActivity.this, SignalStaticListActivity.class);
                startActivity(it);
            }
        });
        ...
        one_key_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(SignalStaticActivity.this, SignalStaticOneKeyActivity.class);
                startActivity(it);
            }
        });
    }
