...
public class SignalStaticOneKeyActivity extends AppCompatActivity {
    ...
    private Toolbar.OnMenuItemClickListener onMenuItemClick = new Toolbar.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if(!msg.equals("")) {
                Toast.makeText(SignalStaticOneKeyActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
            finish();
            return true;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signal_static_one_key);
        ...
        DetailInformationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent it = new Intent(SignalStaticOneKeyActivity.this, SignalStaticDetailInformationActivity.class);
                startActivity(it);
            }
        });
    }
