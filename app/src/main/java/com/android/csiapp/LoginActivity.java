...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private boolean isUserValid(String user) {
        ...
        return user.toString().equals("admin");
    }

    private boolean isPasswordValid(String password) {
        //TODO: Replace this with your own logic
        return password.toString().equals("123456");
    }
    ...
    private void addUserToAutoComplete(List<String> UserIdCollection) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success && "Q5_LY".equalsIgnoreCase(SystemProperties.get("ro.product.device"))) {
                ...
                Toast.makeText(LoginActivity.this, "裝置無法登入", Toast.LENGTH_SHORT).show();
            } else {
